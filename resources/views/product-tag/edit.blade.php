        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container">
                <form class="form d-flex flex-column flex-lg-row"
                      action="{{ route('product-tags.update', $productTag) }}"
                      method="post">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10">
                                    ...
                                    <input type="text" name="title" class="form-control mb-2"
                                           placeholder="Тег" value="{{ $productTag->title }}"/>
                                    @error('title')
                ...
                <form id="product-tags-destroy" action="{{ route('product-tags.destroy', $productTag) }}" method="post">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
