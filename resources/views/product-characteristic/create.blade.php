    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container">
                <form class="form d-flex flex-column flex-lg-row" action="{{ route('product-characteristics.store') }}"
                      method="post">
                    @csrf
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 me-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10">
                                    <label class="form-label required">Название характеристика</label>
                                    <input type="text" name="title" class="form-control mb-2"
                                           placeholder="Характеристика" value="{{ old('title') }}"/>
                                    @error('title')
