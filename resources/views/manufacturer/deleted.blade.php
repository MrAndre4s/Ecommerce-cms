                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            @foreach($deleteManufacturers as $manufacturer)
                                <tr>
                                    <td>
                                    ...
                                    <td class="text-end pe-0">
                                        <span class="fw-bold">
                                            {{ $manufacturer->deleted_at->format('d/m/Y h:i') }}
                                        </span>
                                    </td>
                                    <td class="text-end pe-0">
                                    ...
                                    <td class="d-flex flex-row justify-content-end gap-2">
                                        <form action="{{ route('manufacturers.restore', $manufacturer) }}"
                                              method="post">
                                            @csrf
                                            <button type="submit" class="btn btn-primary">Восстановить</button>
                                        </form>
                                        <form action="{{ route('manufacturers.force_delete', $manufacturer) }}"
                                              method="post">
                                            @csrf
                                            @method('DELETE')
