                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10">
                                    ...
                                    <input type="text" name="title" class="form-control mb-2"
                                           placeholder="Производитель" value="{{ $manufacturer->title }}"/>
                                    <div class="text-muted fs-7">Название производителя должно быть уникальным</div>
                                    @error('title')
                            ...
                            <div class="card-body pt-0">
                                <select class="form-select mb-2" name="post_status" data-control="select2"
                                    ...
                                    @foreach($postStatus as $key => $status)
                                        <option value="{{ $status }}"
                                            @selected($manufacturer->post_status == $status)>{{ $status }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('post_status')
